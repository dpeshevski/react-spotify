...
class Discover extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (!prevProps.app.spotifyCredentials.authenticated && this.props.app.spotifyCredentials.authenticated) {
      this.newReleased();
    }

    if (!prevProps.albums.newReleased.rendered && this.props.albums.newReleased.rendered) {
      this.featuredPlaylists();
    }

    if (!prevProps.albums.featuredPlaylists.rendered && this.props.albums.featuredPlaylists.rendered) {
      this.categories()
    }
  }
